namespace Cabspot.Migrations
{
    ...
    public partial class mi : DbMigration
    {
        public override void Up()
        {
            ...
            //RenameIndex(table: "cabspotdb.vehiculo", name: "IX_empleados_idEmpleado", newName: "IX_registradoPor");
        }
        
        public override void Down()
        {
            //RenameIndex(table: "cabspotdb.vehiculo", name: "IX_registradoPor", newName: "IX_empleados_idEmpleado");
